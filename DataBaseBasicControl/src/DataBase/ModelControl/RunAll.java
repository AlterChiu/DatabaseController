...
public class RunAll {
	...
	public RunAll(TreeMap<String, String> profile) throws SQLException, ClassNotFoundException, ParseException {
		...
		ReadAllDataBase readDB = new ReadAllDataBase(readImplement);
